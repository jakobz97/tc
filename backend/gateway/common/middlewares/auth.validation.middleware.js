...
/**
 * @function (01) check if user has set any authorization header - if not return error
 *           (02) split the authorization header and obtain the bearer token - double check if token provided is a bearer
...
/**
 * @function (01) check if user has set any authorization header
